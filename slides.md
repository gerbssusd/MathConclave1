...
<img v-click.hide src="/2A5a.png" alt="Styled Image" class="w-full h-auto object-cover"/><img v-click src="/2A5a-b.png" alt="Styled Image" class="w-full h-auto object-cover"/>
